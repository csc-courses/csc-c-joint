...
- [Basic Computer Architecture](http://localhost:8888/notebooks/architecture/basic-architecture.ipynb)
- [Memory and the CPU](https://github.com/csc-courses/csc-c-joint/blob/main/bits-and-bytes/bit-bytes-integers.ipynb)
- [References, Pointers and Memory](http://localhost:8888/notebooks/architecture/references-and-pointers.ipynb)
